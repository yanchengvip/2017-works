class CreateVirtualTrades < ActiveRecord::Migration[5.1]
  def change
    create_table :virtual_trades, comment: '虚拟交易表' do |t|
    ...
    add_index :virtual_trades, [:account_id, :close_time], name: 'account_close_time_index'
    add_index :virtual_trades,:close_time
  end
end
