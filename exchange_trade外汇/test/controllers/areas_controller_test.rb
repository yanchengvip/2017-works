...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { active: @area.active, area_id: @area.area_id, name: @area.name } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { active: @area.active, area_id: @area.area_id, name: @area.name } }
